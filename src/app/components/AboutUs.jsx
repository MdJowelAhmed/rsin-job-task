...
const AboutUsSection=()=> {
  return (
    <section className="bg-gray-100 text-gray-700 px-6 md:px-16 py-12">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        {/* Left Content */}
        <div className="bg-white py-24 px-6 rounded-lg">
          <h4 className="text-green-600 font-medium text-lg mb-2">About Us</h4>
