    ...
    <section className="bg-gray-50 py-12 px-4 md:px-8 lg:px-16">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 flex flex-col justify-between">
          <p className="text-gray-500 text-sm">New investors <br /> last month</p>
        ...
        <div className="bg-[#7CE4A1] rounded-lg shadow-md p-6 flex flex-col justify-between">
          <p className="text-gray-500 text-sm">Unique investments <br /> last month</p>
          <h3 className="text-4xl font-bold">8,457</h3>
        </div>

        {/* Stats Card 3 */}
        <div className="bg-[#7CE4A1] rounded-lg shadow-md p-6 flex flex-col justify-between">
          <p className="text-gray-500 text-sm">Total invested <br /> last month</p>
        ...
        {/* Stats Card 4 */}
        <div className="bg-white rounded-lg shadow-md p-6 flex flex-col justify-between">
          <p className="text-gray-500 text-sm">Site visitors <br /> last month</p>
