...
const Testimonials = () => {
  ...
  return (
    <section className="bg-blue-900 text-white py-12 px-6 relative">
      <div className="mb-16">
        {/* Header */}
        ...
        >
          {testimonials.map((t, index) => (
            <SwiperSlide key={index}>
              <div className="bg-white text-gray-700 rounded-lg shadow-lg p-4 h-52 flex flex-col justify-between">
                {/* Content */}
                <div>
                  <div className="flex justify-between ">
                    <div className="">
                  ...
                  <div className="flex justify-between items-center mt-4">
                    <div className="flex items-center gap-1  mb-2">
                      {[...Array(5)].map((_, i) => (
                        <IoStarOutline  key={i} className="bg-[#2B9851] text-white" />
                      ))}
                    </div>
                    {/* Date */}
